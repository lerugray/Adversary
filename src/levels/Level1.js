...
const Level1Data = {
  ...
  platforms: [
    ...
    // Platform at (48, 176): traversal - first clean landing after the opening ladder.
  ...
  ladders: [
    { x: 56,  topY: 176, bottomY: 224, w: 14 },
  ...
  decorations: [
    ...
    { x: 28,  y: 220, w: 18, h: 4,  color: 0x007800 },
    { x: 40,  y: 116, w: 8,  h: 12, color: 0x503000 },
