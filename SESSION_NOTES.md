...
- More browser playtesting still needed for Level 2 archer pressure, Level 3 trap timing, checkpoint feel, and boss arena spacing

## What's next
- Playtest Level 2 in-browser from `index.html` for archer pressure and route clarity
